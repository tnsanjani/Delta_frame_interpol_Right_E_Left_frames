...
class StereoEventDataset(Dataset):
    def __init__(
        self, video_data_dir,
        frame_height, frame_width, num_frames,
        random_seed=42):
        ...
        self.transform_rgb = transforms.Compose([
            transforms.Resize((frame_height, frame_width), interpolation=transforms.InterpolationMode.BILINEAR),
            transforms.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5])
        ])
        self.transforms_evs = transforms.Compose([
            transforms.Normalize(mean=[0.5] * 6, std=[0.5] * 6, inplace=True)
        ])
    ...
    def _load_rgb(self, num_frames, rgb_paths: List[str]):
    ...
    def _load_depth(self, num_frames, depth_paths: List[str]) -> torch.Tensor:
        depth_list = []
        for path in depth_paths[:num_frames]:
    ...
    def _load_events(self, event_paths, num_frames, num_channels=6):
        event_frames = []
    ...
    def __getitem__(self, idx: int):
        ...
        left_rgb = self._load_rgb(self.num_frames, paths['left']['rgb'])
        left_depth = self._load_depth(self.num_frames, paths['left']['depth'])
        left_event = self._load_events(paths['left']['event'], self.num_frames)

        right_rgb = self._load_rgb(self.num_frames, paths['right']['rgb'])
        right_depth = self._load_depth(self.num_frames, paths['right']['depth'])
        right_event = self._load_events(paths['right']['event'], self.num_frames)
        ...
        left_pixel_values = apply_transform_to_sequence(left_rgb, self.transform_rgb)
        right_pixel_values = apply_transform_to_sequence(right_rgb, self.transform_rgb)

        left_events = apply_transform_to_sequence(left_event, self.transforms_evs)
        right_events = apply_transform_to_sequence(right_event, self.transforms_evs)
        ...
        sample = dict(left=dict(pixel_values=left_pixel_values,events=left_events,depth=left_depth,plucker_embedding=plucker_embedding_left),
            right=dict(pixel_values=right_pixel_values,events=right_events,depth=right_depth,plucker_embedding=plucker_embedding_right),
...
#     print(f"left_pixel_values_batch shape is {left_pixel_values_batch.shape}, Right events shape: {right_events_batch.shape}")


#bs_ergb_data output
#  pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
# -------------
#  pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
# -------------
# (torch.Size([1, 5, 8, 40, 64]), torch.Size([1, 1, 1024]), torch.Size([1, 5, 6, 320, 512])) are input shapes to inpu_noisy, clip_hidden and event shapes
# (torch.Size([1, 5, 8, 40, 64]), torch.Size([1, 1, 1024]), torch.Size([1, 5, 6, 320, 512])) are input shapes to inpu_noisy, clip_hidden and event shapes
# sample shape is torch.Size([5, 320, 40, 64]) and evenst condition shape is torch.Size([5, 320, 40, 64])
# sample shape is torch.Size([5, 320, 40, 64]) and evenst condition shape is torch.Size([5, 320, 40, 64])
# Steps:   0%|                                                                                     | 0/63000 [00:14<?, ?it/s, lr=5e-5, step_loss=0.21] pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
# -------------
#  pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
...
# Steps:   0%|                                                                                                                                                                                                                              | 0/63000 [00:00<?, ?it/s] pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
# -------------
#  pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])--for latents
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
# -------------
# latents shape is torch.Size([1, 5, 4, 40, 64])
# latents shape is torch.Size([1, 5, 4, 40, 64])
# condiitonal latents shape is torch.Size([1, 4, 40, 64])
# condiitonal latents shape is torch.Size([1, 4, 40, 64])
# initial inp_noisy_latents below is torch.Size([1, 5, 4, 40, 64]) and torch.Size([1, 5, 4, 40, 64]) beofre concatination
# after concatination  torch.Size([1, 5, 8, 40, 64])
#  initial sample shape is torch.Size([1, 5, 8, 40, 64])
# initial inp_noisy_latents below is torch.Size([1, 5, 4, 40, 64]) and torch.Size([1, 5, 4, 40, 64]) beofre concatination
# after concatination  torch.Size([1, 5, 8, 40, 64])
#  initial sample shape is torch.Size([1, 5, 8, 40, 64])
# sample shape is torch.Size([5, 320, 40, 64]) and evenst condition shape is torch.Size([5, 320, 40, 64])
# sample shape is torch.Size([5, 320, 40, 64]) and evenst condition shape is torch.Size([5, 320, 40, 64])
# Steps:   0%|                                                                                                                                                                                                    | 0/63000 [00:15<?, ?it/s, lr=5e-5, step_loss=0.179] pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])
#  pixel values rgbshape is torch.Size([1, 5, 3, 320, 512])
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
# -------------
#  conditional_pixel_values values rgbshape is torch.Size([1, 1, 3, 320, 512])
